...
"""
    ...
    <body>
      ...
      <div class="preMadeSets">
            <div><form action="/monochromePreSets">
                <button type="submit">Monochrome</button>
            </form></div>
            <div><form action="/blinkPreSets">
                <button type="submit">Blink</button>
            </form></div>
            <div><form action="/interpolatePreSets">
                <button type="submit">Interpolate</button>
            </form></div>
            <div><form action="/rainbowPreSets">
                <button type="submit">Rainbow</button>
            </form></div>
                <div><form action="/firePreSets">
                <button type="submit">Fire!</button>
            </form></div>
                <div><form action="/randomPreSets">
